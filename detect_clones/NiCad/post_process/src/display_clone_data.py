...
if __name__ == "__main__":
    ...
    input_file = sys.argv[1] if len(sys.argv) > 1 else "../data/java/nicad_camel_clone_func.jsonl"
    # input_file = sys.argv[1] if len(sys.argv) > 1 else "../data/java/nicad_camel_clone_func_small.jsonl"
